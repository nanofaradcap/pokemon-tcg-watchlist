...
exports.extractTCGplayerMatch = extractTCGplayerMatch;
exports.normalizeCardName = normalizeCardName;
exports.areCardsSame = areCardsSame;
exports.extractPriceChartingMatch = extractPriceChartingMatch;
exports.cardsMatch = cardsMatch;
exports.extractCardMatch = extractCardMatch;
/**
 ...
 */
function extractTCGplayerMatch(cardName) {
 ...
 */
function areCardsSame(card1, card2) {
    // Normalize numbers by removing leading zeros
    const normalizeNumber = (num) => num.replace(/^0+/, '') || '0';
 ...
 */
function extractCoreCardName(name) {
    return name
 ...
 * Returns: { name: "Gardevoir ex", number: "348" }
 */
function extractPriceChartingMatch(cardName) {
 ...
 */
function extractCardMatch(cardName, url, cardNumber) {
    // Validate inputs
